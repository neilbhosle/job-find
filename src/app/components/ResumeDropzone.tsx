  ...
  return (
    <div
      className={cx(
        ...
        isHoveredOnDropzone && "border-[#7788EE]",
      ...
      >
        ...
        {!hasFile ? (
          ...
          <div className="flex items-center justify-center gap-3 pt-3">
            ...
            <button
              type="button"
              className="outline-[#7788EE] rounded-md p-1 text-gray-400 hover:bg-gray-100 hover:text-gray-500"
              title="Remove file"
              onClick={onRemove}
            >
        ...
        <div className="pt-4">
          {!hasFile ? (
            <>
              <label
                className={cx(
                  "within-outline-theme-purple cursor-pointer rounded-full px-6 pb-2.5 pt-2 font-semibold shadow-sm border border-[#212e7c] bg-[#7788EE] text-white",
                  playgroundView ? "border" : "bg-[#7788EE]"
                )}
              >
                Browse file
                <input
            ...
            <>
              {!playgroundView && (
                <button
                  type="button"
                  className="bg-[#7788EE] text-white rounded-md px-4 py-2 hover:bg-[#212e7c]"
